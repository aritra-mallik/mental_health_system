  ...
  return (
    <View className="flex-1 bg-neutral-50 dark:bg-black">
      ...
      >
        ...
        <TouchableOpacity 
          onPress={() => router.back()} 
          className="px-5 py-3 mb-8 bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 shadow-sm rounded-2xl self-start flex-row items-center"
        >
        ...
        {/* Card 1: Doctor Info */}
        <Card className="bg-white dark:bg-neutral-900 rounded-[2.5rem] p-6 border border-neutral-200 dark:border-neutral-800 shadow-sm mb-6 flex-row items-center">
          <View className="w-20 h-20 bg-rose-50 dark:bg-rose-900/10 rounded-[1.5rem] items-center justify-center shadow-sm border border-rose-100 dark:border-rose-500/20">
          ...
          <View className="ml-5 flex-1 justify-center">
            ...
            <View className="flex-row items-center gap-2 flex-wrap">
              <View className="flex-row items-center bg-amber-50 dark:bg-amber-500/10 border border-amber-200 dark:border-amber-500/30 px-2.5 py-1 rounded-lg">
        ...
        <Card className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-[2.5rem] p-6 md:p-8 shadow-sm mb-6">
          ...
          <View className="flex-row items-center mb-6">
            <View className="w-10 h-10 rounded-[1rem] bg-rose-50 dark:bg-rose-900/20 items-center justify-center mr-3 border border-rose-100 dark:border-rose-500/30">
          ...
          <View className="flex-row flex-wrap justify-between gap-y-4 gap-x-2">
            <View className="flex-1 min-w-[45%] bg-neutral-50 dark:bg-neutral-800 p-4 rounded-[1.5rem] border border-neutral-200 dark:border-neutral-700 shadow-sm items-center">
            ...
            <View className="w-full bg-neutral-50 dark:bg-neutral-800 p-4 rounded-[1.5rem] border border-neutral-200 dark:border-neutral-700 shadow-sm items-center">
        ...
        <Card className="bg-neutral-100 dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-[2.5rem] p-6 md:p-8 shadow-sm mb-6">
      ...
      <View className="absolute bottom-0 left-0 right-0 pt-4 pb-8 px-5 bg-neutral-50/90 dark:bg-black/90 border-t border-neutral-200 dark:border-neutral-800 backdrop-blur-xl">
        <Button 
          className="h-14 rounded-2xl flex-row w-full shadow-sm bg-rose-600 dark:bg-rose-500"
        ...
        <View className="flex-1 justify-center items-center bg-black/60 px-5">
          <Card className="w-full max-w-sm bg-white dark:bg-neutral-900 rounded-[2.5rem] p-8 items-center shadow-2xl border border-neutral-200 dark:border-neutral-800">
            ...
            {isProcessing ? (
              ...
              <>
                <View className="w-20 h-20 bg-rose-50 dark:bg-rose-900/10 rounded-full items-center justify-center mb-6 shadow-sm border border-rose-100 dark:border-rose-500/20">
                ...
                <View className="flex-row w-full gap-3 flex-wrap">
                  <Button 
                    className="flex-1 h-14 bg-neutral-100 dark:bg-neutral-800 rounded-2xl border border-neutral-200 dark:border-neutral-700"
                  ...
                  <Button 
                    className="flex-1 h-14 rounded-2xl bg-rose-600 dark:bg-rose-500"
